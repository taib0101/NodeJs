...
const importedRequestResponseHandler = require(`${__dirname}/helper/handleRequestResponse`);
const importedEnvironmentHandler = require(`${__dirname}/helper/environmentHandler`);
...
async function dataMain() {
    ...
    while (inputTestCase--) {
        ...
        if (readCRUD === "create") {
            data.create(directory, file, (objectInformation) => {
                console.log("Create File :", objectInformation);
            })
        } else if (readCRUD === "read") {
            data.read(directory, file, (objectInformation, exactInformation, read) => {
            ...
            data.update(directory, file, updateData, (objectInformation, exactInformation, read) => {
                console.log("update File :", objectInformation);
                console.log("Exact Information :", exactInformation);
                console.log("Update :\n", read);
            });
        } else {
            data.delete(directory,file,(objectInformation,exactInformation) => {
